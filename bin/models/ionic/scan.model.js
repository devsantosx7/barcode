...
class ScanModel {
    ...
    */
    static ToString(scan, fieldSeparator = ' ') {
     ...
     */
    static ToCSV(scannings, exportOnlyText, enableQuotes, csvDelimiter, newLineCharacter, generateHeaders) {
        const papaOptions = {
            quotes: enableQuotes,
        ...
        scannings = scannings.map(scan => {
            if (exportOnlyText) {
                scan.outputBlocks = scan.outputBlocks
                    .filter(outputBlock => (outputBlock.type != 'key' &&
...
//# sourceMappingURL=scan.model.js.map